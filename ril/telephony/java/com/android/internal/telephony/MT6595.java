 ...
 * {@hide}
 */
public class MT6595 extends RIL implements CommandsInterface {
    ...
    public MT6595(Context context, int preferredNetworkType, int cdmaSubscription) {
        super(context, preferredNetworkType, cdmaSubscription, null);
    }

    public MT6595(Context context, int preferredNetworkType,
