# mt6595 platform boardconfig
LOCAL_PATH := device/lenovo/x2to
-include vendor/lenovo/x2to/BoardConfigVendor.mk
...
TARGET_OTA_ASSERT_DEVICE := x2to,x2cu,x2ap,x2eu

# kernel
BOARD_KERNEL_CMDLINE := bootopt=64S3,32S1,32S1 androidboot.selinux=permissive
BOARD_KERNEL_BASE := 0x40000000
BOARD_KERNEL_PAGESIZE := 2048
BOARD_MKBOOTIMG_ARGS := --base 0x40000000 --pagesize 2048 --kernel_offset 0x00008000 --ramdisk_offset 0x04000000 --second_offset 0x00f00000 --tags_offset 0x0e000000 --board Bule
...
# RIL
BOARD_RIL_CLASS := ../../../device/lenovo/x2to/ril/
